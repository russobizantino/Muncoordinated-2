...
export const COUNTRY_OPTIONS = [
  {key: 'sc1', value: 'sc1', flag: 'sc', text: 'Con. Gabriel Russo (LIB-SC)'},
  {key: 'sc2', value: 'sc2', flag: 'sc', text: 'Con. Will Padilha (LBM-SC)'},
  {key: 'sc3', value: 'sc3', flag: 'sc', text: 'Con. Ricardo Cesar (LIB-SC)'},
  {key: 'pr', value: 'pr', flag: 'pr', text: 'Con. Fernando Havi (LIB-PR)'},
  {key: 'sc4', value: 'sc4', flag: 'sc', text: 'Con. Arthur Souza (LIB-SC)'},
  {key: 'sc5', value: 'sc5', flag: 'sc', text: 'Con. Paulo Leonardi (CON-SC)'},
  {key: 'sp1', value: 'sp1', flag: 'es', text: 'Con. Gaby Silva (CON-SP)'},
  {key: 'am', value: 'am', flag: 'am', text: 'Con. Vinicius Medeiros (LBM-AM)'},
  {key: 'sp2', value: 'sp2', flag: 'es', text: 'Con. Esther Lawall (CON-SP)'},
];